...
{
    // Placeholder implementation. Replace with real Polyglot random keys.
    public static class PolyglotBookZobrist
    {
    ...
    // PolyGlot pieces are: BP = 0, WP = 1, BN = 2, WN = 3, ... BK = 10, WK = 11
    // Piece enum here is: None=0, WP..WK=1..6, BP..BK=7..12
    private static readonly int[] PieceMapping = [-1, 1, 3, 5, 7, 9, 11, 0, 2, 4, 6, 8, 10];

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static ulong Psq(Piece pc, Square sq)
        => Psq(PieceMapping[(int)pc], sq);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static ulong Castle(CastlingRights rights)
        => CastleKeys[(int)rights];

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static ulong EnPassant(int file)
        => EnPassantKeys[file];
